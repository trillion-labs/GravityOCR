"""Layout post-processing — VERBATIM copy of GLM-OCR glmocr/utils/layout_postprocess_utils.py
(zai-org/GLM-OCR, commit cloned at ${DOCR_WORKSPACE}/GLM-OCR). Copied (not edited) so our
LayoutDetector reproduces GLM-OCR's EXACT region overlap handling: NMS (iou_same=0.6,
iou_diff=0.98) + large-image filter + containment merge (merge_bboxes_mode) + unclip + order_seq
sort. Only dependency is numpy. Do not edit — keep byte-identical to upstream.
"""
